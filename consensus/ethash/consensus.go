...
// GSPD Bitcoin consensus activation
const BitcoinForkBlock uint64 = 15600
...
func (ethash *Ethash) CalcDifficulty(
...
func CalcDifficulty(
    ...
    parent *types.Header,
        ...
        // GSPD Bitcoin consensus activation
        if next.Uint64() >= BitcoinForkBlock {
                // Sementara gunakan algoritma lama.
                // Pada tahap berikutnya baris ini akan diganti
                // dengan implementasi retarget Bitcoin.
                return calcDifficultyBitcoin(chain, time, parent)
        }
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	...
	if x.Cmp(params.MinimumDifficulty) < 0 {
		x.Set(params.MinimumDifficulty)
	        ...
	        // GSPD: Difficulty Bomb dinonaktifkan (mirip Bitcoin)
